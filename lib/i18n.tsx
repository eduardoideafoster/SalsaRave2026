...
const dictionaries: Record<Lang, Dict> = {
  en: {
    ...
    'finance.paidHint': '{guests} attendees in the app · {rows} lines in the ticketing export',
    'finance.hotelCost': 'Hotel cost',
    'finance.hotelCostHint': '{n} unique nights',
    'finance.paidHintClosed': "edition total · {imported} imported from ticketing",
    'finance.hotelCostHintClosed': "hotel's final invoice · {computed} from the bookings",
    'finance.splitNote': 'split computed from the bookings',
  ...
  es: {
    ...
    'finance.paidHint': '{guests} asistentes en la app · {rows} líneas en el export de venta',
    'finance.hotelCost': 'Coste hotel',
    'finance.hotelCostHint': '{n} noches únicas',
    'finance.paidHintClosed': 'total de la edición · {imported} importados de ticketing',
    'finance.hotelCostHintClosed': 'factura final del hotel · {computed} según las reservas',
    'finance.splitNote': 'reparto calculado desde las reservas',
