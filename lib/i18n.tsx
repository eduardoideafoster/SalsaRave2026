...
const dictionaries: Record<Lang, Dict> = {
  en: {
    ...
    'finance.imported': '[{mode}] {inserted} inserted · {updated} updated · {skipped} skipped · {dedupedInFile} in-file dupes (total {amount})',
  ...
  es: {
    ...
    'finance.imported': '[{mode}] {inserted} insertados · {updated} actualizados · {skipped} ignorados · {dedupedInFile} duplicados internos (total {amount})',
    'finance.importError': 'Error: {msg}',
