...
const dictionaries: Record<Lang, Dict> = {
  en: {
    ...
    'finance.imported': 'Imported {inserted} new + {updated} updated (total {amount})',
  ...
  es: {
    ...
    'finance.imported': 'Importados: {inserted} nuevos + {updated} actualizados (total {amount})',
    'finance.importError': 'Error: {msg}',
